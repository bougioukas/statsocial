...
### Independent and dependent and  variables
...
For example, consider a study investigating the link between caffeine intake (X) and lung cancer (Y). Without accounting for confounding variables, such as smoking, the results may suggest a misleading association between caffeine and lung cancer that is not truly causal.
...
Smoking may be a potential confounding variable because is:
...
-   **Not Part of the Causal Pathway:** Smoking does not lie in the causal pathway between caffeine and lung cancer.
